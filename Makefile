...
main: build/gui/main.o build/gui/driver/irrlichtscreen.o build/gui/driver/irrlichtreceiver.o build/gui/driver/texturepack.o build/gui/driver/texturecard.o build/net/tdsocket/Socket.o build/gui/driver/button.o build/gui/driver/clickbox.o build/gui/game/game.o build/gui/game/gooey.o build/gui/game/gooeyset.o build/gui/game/testgame.o build/gui/driver/textcard.o build/gui/driver/inputbox.o
